...
- [2026-05-28_derive-dont-guess-enforcement.md](2026-05-28_derive-dont-guess-enforcement.md) — APPROVED 2026-05-28 (Components 1–5): give `derive-dont-guess` hook teeth (advisory PostToolUse path-literal check + opt-in PreToolUse block + propagation fix + non-hook elevations); Component 6 PROPOSED — extend trigger-based enforcement to plan-persistence and output-length. Companion audit: `reviews/2026-05-28_derive-dont-guess-binding-audit.md`
