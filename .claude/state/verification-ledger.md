...
| .claude/hooks/test_citation_existence_lib.py | tests-pass | 2026-05-30T02:10Z | 354e3291dd74 | PASS | re-ran standalone (Phase 4 non-destructiveness check): 24/24 checks passed, exit 0; prior row hash bec8cc7518cb stale (20/20) — file grew independently of Phase 4, which touched no .py | 1 | | |
| .claude/hooks/test_normdiff_lib.py | tests-pass | 2026-05-30T02:10Z | 14d316326ba3 | PASS | re-ran standalone (Phase 4 non-destructiveness check): 36/36 checks passed, exit 0; hash unchanged from 2026-05-29T20:00Z row — Phase 4 did not touch this file | 1 | | |
| .claude/skills/tools/cite_check.py | cli-smoke | 2026-05-29T19:05Z | 947e5a3c9d38 | PASS | (a) test_normdiff_lib.py:51 -> RESOLVED exit0; (b) :99999 -> MISSING (out of range, 501 lines) exit1; (c) ::test_python_injected_line_residue -> RESOLVED test passed exit0 | 2 | .claude/hooks/test_normdiff_lib.py:51 | |
| Phase 4 (working tree) | docs-only-no-code-touched | 2026-05-30T02:10Z | n/a | PASS | git diff --name-only (tracked+staged+untracked) = 5 paths, all .md/.lock; grep for .py\|hooks/\|settings.json = 0 matches; both hook test suites unchanged & green | 1 | | |
| .claude/hooks/primary_source_lib.py | diagnosis:comma-author-list-drops-lead | 2026-07-01T23:55Z | 67d473ab215c | DIAGNOSED | 3-slot regex: third author required Oxford ", and"; comma-only + AEA 4-author lists failed at lead anchor, regex restarted mid-list (Bohren,Imas,Rosenberg->imas_rosenberg_2019; repro in-session). Fixed: single repeated authors group + AUTHOR_SEP split. |
